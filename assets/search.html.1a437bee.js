import{_ as p}from"./plugin-vue_export-helper.21dcd24c.js";import{r as c,o as v,c as h,b as n,a as s,w as i,f as e,g as u}from"./app.625f2658.js";const m={},b=e("The theme adds built-in support for "),g={href:"https://v2.vuepress.vuejs.org/reference/plugin/search.html",target:"_blank",rel:"noopener noreferrer"},_=n("code",null,"@vuepress/plugin-search",-1),k=e(" and "),q={href:"https://v2.vuepress.vuejs.org/reference/plugin/docsearch.html",target:"_blank",rel:"noopener noreferrer"},y=n("code",null,"@vuepress/plugin-docsearch",-1),f=e(". Just install the plugin you want and config it, you will get a search box in navbar."),x=e("To use search plugin, you need to apply it via "),w=n("code",null,"plugins",-1),T=e(" in the "),I=n("strong",null,"VuePress config file",-1),P=e("."),N=u('<div class="custom-container warning"><p class="custom-container-title">Note</p><p>The theme is just adding support for the above plugins, it does not bundle them. You need to install and apply them yourself.</p></div><div class="custom-container danger"><p class="custom-container-title">Warning</p><p><strong>DO NOT</strong> use <code>plugins.search</code> in theme options.</p><p>The theme can ONLY apply plugins it bundles, so <code>plugins</code> field in theme options ONLY accepts CERTAIN plugin name.</p></div><h2 id="use-vuepress-plugin-search" tabindex="-1"><a class="header-anchor" href="#use-vuepress-plugin-search" aria-hidden="true">#</a> Use <code>@vuepress/plugin-search</code></h2>',3),S=n("p",null,[e("Install "),n("code",null,"@vuepress/plugin-search")],-1),A=n("div",{class:"language-bash ext-sh line-numbers-mode"},[n("pre",{class:"language-bash"},[n("code",null,[n("span",{class:"token function"},"pnpm"),e(),n("span",{class:"token function"},"add"),e(` -D @vuepress/plugin-search@next
