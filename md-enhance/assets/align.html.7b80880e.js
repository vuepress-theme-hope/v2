import{_ as o}from"./plugin-vue_export-helper.21dcd24c.js";import{o as v,c as m,a as i,w as s,b as e,e as l,d as n,r as a}from"./app.988efa2e.js";const b={},h=l(`<p>By injecting configuration into vuepress-plugin-container, you can use</p><div class="language-markdown ext-md line-numbers-mode"><pre class="language-markdown"><code>::: center
Paragraph to center
:::
...
:::
::::
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,1);function A(C,S){const r=a("CodeTabs"),t=a("ExternalLinkIcon");return v(),m("div",null,[h,i(r,{data:[{title:"TS"},{title:"JS"}],"tab-id":"language"},{tab0:s(({title:d,value:c,isActive:u})=>[g]),tab1:s(({title:d,value:c,isActive:u})=>[p]),_:1}),_,e("div",f,[x,k,y,P,e("div",E,[e("p",null,[e("a",I,[V,i(t)]),T])])]),w])}var W=o(b,[["render",A],["__file","align.html.vue"]]);export{W as default};
